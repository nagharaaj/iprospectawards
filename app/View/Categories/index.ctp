...
<div id="categories-container">
	...
	<div id="pioneering-solutions">
		<h2 class="orange-shadow"><a href="../submission/form1/pioneering">Pioneering Solutions that Drive Industry Leading Results</a></h2>
	...
	<div id="ambitiously-driving">
		<h2 class="blue-shadow"><a href="../submission/form1/ambitiously">Ambitiously Driving the Aegis Operating Model</a></h2>
	...
	<div id="digital-performance">
		<div class="left-block">
			<h2 class="green-shadow"><a href="../submission/form1/digital">Digital Performance on a Global Scale</a></h2>
		...
		<div class="right-block">
			<h2 class="grey-shadow"><a href="../submission/form2/cultivating">Cultivating Culture</a></h2>
